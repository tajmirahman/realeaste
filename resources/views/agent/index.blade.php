...
@section('agent')
    ...
    <div class="page-content">
        ...
        @if ($status == 'active')
            <h4>Your Account Is <span class="text-success">Approve</span></h4>
        @else
            <h4>Your Account Is <code>Inapprove</code></h4>
            <p class="mb-3"><code>Please Wait Admin Approve your Account as soon as poosible</code></p>
        @endif
