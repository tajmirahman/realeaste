            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('store.post') }}" id="myForm" class="forms-sample" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="row">
                                <div class="col-12 form-group mb-3 ">
                                    <label class="form-label">Title</label>
                                    <input type="text" class="form-control" autocomplete="off" name="post_title">
                                </div>
                                ...
                                <div class="col-6 form-group mb-3 ">
                                    ...
                                    <input type="text" id="tags" class="form-control" autocomplete="off" name="post_tags">
                                </div>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary me-2 px-3">Add Blog Post</button>
                                </div>
