            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('store.property') }}" id="myForm" class="forms-sample" method="POST"
                            ...
                            <div class="col-12 form-check mb-2">
                                <input type="checkbox" name="featured" value="1" class="form-check-input" id="checkDefault">
                            ...
                            <div class="col-12 form-check mb-2">
                                <input type="checkbox" name="hot" value="1" class="form-check-input" id="checkDefault">
                                <label class="form-check-label" for="checkDefault">
                                    Hot
                                </label>
                            </div>
