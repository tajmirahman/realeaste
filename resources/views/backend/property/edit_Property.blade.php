            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.property') }}" id="myForm" class="forms-sample" method="POST"
                            ...
                            <div class="row mb-3 ">
                                ...
                                <div class="col-3 form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" autocomplete="off" value="{{ $property->zipcode }}"  name="zipcode">
                                </div>
                                    ...
                                    <select class="js-example-basic-multiple form-select" multiple="multiple"
                                        ...
                                        @foreach ($amenitie as $item)
                                            <option value="{{ $item->amenitie_name }}"
                                                {{ in_array($item->amenitie_name, $property_ami) ? 'selected' : '' }}>
                                                {{ $item->amenitie_name }}
                                ...
                                <div class="col-4 form-group mb-3">
                                    ...
                                    <select class="form-select" name="agent_id">
                                        ...
                                        @foreach ($agent as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $property->agent_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
