            ...
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('store.site')}}" id="myForm" class="forms-sample" method="POST">
                            @csrf
                            ...
                            <div class="row mb-3 ">
                                ...
                                <div class="col-sm-9 form-group">
                                    <input type="text" class="form-control" autocomplete="off" name="open_time">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <button type="submit" class="btn btn-primary me-2 px-3">Add Site</button>
                                </div>
                            </div>
